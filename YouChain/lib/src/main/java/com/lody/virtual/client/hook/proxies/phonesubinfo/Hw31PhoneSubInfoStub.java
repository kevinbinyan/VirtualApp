...
import mirror.com.android.internal.telephony.IPhoneSubInfoMSim;

/**
 * @author Lody
 */
@Inject(MethodProxies.class)
public class Hw31PhoneSubInfoStub extends BinderInvocationProxy {
	public Hw31PhoneSubInfoStub() {
		super(IPhoneSubInfoMSim.Stub.asInterface, "iphonesubinfo_msim");
	}
