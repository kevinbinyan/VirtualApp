...
//                    "20000,input,swipe,0.5,0.3,0.5,0.6",
                    "10000,input,tap,0.093,0.0775",
                    "1000,input,tap,0.093,0.0775",
                    "1000,input,tap,0.714,0.0837",
                    "1000,input,tap,0.714,0.0837",
                    "1000,input,tap,0.5,0.575",
                    "1000,input,tap,0.5,0.575",
                    "2000,input,tap,0.886,0.51",
                    "3000,input,tap,0.5,0.4475",
                    "2000,input,text,<account>",
                    "1000,input,tap,0.188,0.188",
                    "1000,input,tap,0.188,0.188",
                    "2000,input,tap,0.6,0.731",
                    "5000,input,tap,0.5,0.4475",
                    passWaitTime + ",input,text,<password>",
                    "1000,input,tap,0.188,0.188",
                    "1000,input,tap,0.188,0.188",
                    "2000,input,tap,0.6,0.731",
                    "6000,input,tap,0.342,0.62",
                    "3000,input,tap,0.5,0.62",
                    "1000,input,tap,0.971,0.5",
                    "500,input,tap,0.5,0.585",
                    "500,input,tap,0.5,0.585",
                    "2000,input,tap,0.898,0.971",
                    "2000,input,tap,0.125,0.971",
                    "500,input,tap,0.5,0.585",
                    "500,input,tap,0.5,0.585",
                    "3000,input,swipe,0.5,0.6,0.5,0.4",
                    mineWaitTime + ",input,tap,0.5,0.84",
                    "5000,input,tap,0.5,0.84"
    ...
    private static final String[][] emulator_batchOps = {
            ...
            {//进入百度新闻
                    ...
                    "2000,input,tap,0.898,0.971",
                    "2000,input,tap,0.125,0.971",
                    "3000,input,tap,0.142,0.477",
                    "2000,input,tap,0.142,0.25",
                    "2000,input,swipe,0.5,0.3,0.5,0.6",
                    "3000,input,tap,0.272,0.5",
