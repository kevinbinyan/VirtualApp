...
//        checkActivityStatus(context);
    ...
    public static boolean isBigClient(Context context) {
        boolean isBaidu = (boolean) SharedPreferencesUtils.getParam(context, SharedPreferencesUtils.BAIDU, false);
        return isBaidu;
//        ApplicationInfo appInfo = null;
//        try {
//            appInfo = context.getPackageManager().getApplicationInfo(context.getPackageName(), PackageManager.GET_META_DATA);
...
//            e.printStackTrace();
//        }
//        return appInfo.metaData.getBoolean("BIG_CLIENT");
    }

    public static boolean isInsideClient(Context context) {
        ApplicationInfo appInfo = null;
        try {
            appInfo = context.getPackageManager().getApplicationInfo(context.getPackageName(), PackageManager.GET_META_DATA);
        } catch (PackageManager.NameNotFoundException e) {
        ...
        return appInfo.metaData.getBoolean("INSIDE");
    }
