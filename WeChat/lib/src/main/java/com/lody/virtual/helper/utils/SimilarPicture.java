...
//        Bitmap bitmapGray1 = convertGreyImg(bitmap1);
//        Bitmap bitmapGray2 = convertGreyImg(bitmap2);
//        int gray1 = getAvg(bitmapGray1);
//        int gray2 = getAvg(bitmapGray2);
//        String str1 = getBinary(bitmap1, gray1);
//        String str2 = getBinary(bitmap2, gray2);
//        String strhex1 = binaryString2hexString(str1);
//        String strhex2 = binaryString2hexString(str2);
//        char[] s1s = strhex1.toCharArray();
//        char[] s2s = strhex2.toCharArray();
//        int diffNum = 0;
...
//        }
        ...
        while (i < 10) {
            int x = random.nextInt(bitmap1.getWidth());
            int y = random.nextInt(bitmap1.getHeight());
